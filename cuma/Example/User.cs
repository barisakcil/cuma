...
public class Personal : User, IPersonal
{
    ...
    public Personal() { }
    public Personal(string userName, string password, bool isActive, string ssn, decimal salary) : base(userName, password, isActive, tc)
    {
        SSN = ssn;
        Salary = salary;
    }
...
public class Volunteer : User, IVolunteer
{
    ...
    public decimal Salary { get; set; }
    public Volunteer() { }
    public Volunteer(string userName, string password, bool isActive, string ssn, decimal salary) : base(userName, password, isActive, tc)
    {
        SSN = ssn;
        Salary = salary;
    }
...
public class Student:User,IStudent {
    ...
    public Student() { }
    public Student(string userName, string password, bool isActive, int absenteeism, byte marks) : base(userName, password, isActive, tc)
    {
...
public class Jobber:User,IJobber
{
    ...
    public Jobber() { }
    public Jobber(string userName, string password, bool isActive, string workArea) : base(userName, password, isActive,tc)
    {
        WorkArea = workArea;
    }
}
